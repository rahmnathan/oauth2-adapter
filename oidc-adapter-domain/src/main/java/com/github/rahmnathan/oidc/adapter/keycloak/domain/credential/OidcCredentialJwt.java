...
import com.github.rahmnathan.oidc.adapter.keycloak.domain.key.SignerInstructions;
...
@Value
public class OidcCredentialJwt extends OidcCredential {
    ...
    @Builder
    public OidcCredentialJwt(String realm, String clientId, Duration tokenRefreshThreshold, @NonNull String url,
    ...
    @Override
    public String toRequestBody() throws OidcAdapterException {
